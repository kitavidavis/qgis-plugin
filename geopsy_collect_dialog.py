...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'geopsy_collect_dialog_base.ui'))


class GeopsyCollectDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(GeopsyCollectDialog, self).__init__(parent)
